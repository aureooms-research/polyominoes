"""
    ...
    A000104(n) + A001419(n) = A000105(n)

    >>> all(map(lambda n: free_without_holes[n] + free_with_holes[n] == free[n], range(20)))
    True
...
"""
A001419 = M4226 = N1767 = free_with_holes = (0, 0, 0, 0, 0, 0, 0, 1, 6, 37,
                195, 979, 4663, 21474, 96496, 425449, 1849252, 7946380,
                33840946, 143060339, 601165888, 2513617990, 10466220315,
                43425174374, 179630865835, 741123699012, 3050860717372)
...
"""
    Number of free n-celled polyominoes without holes and odd side lengths. 		1

    https://oeis.org/A217595
"""

A217595 = free_without_holes_with_odd_side_length = (1, 1, 0, 1, 1, 2, 4, 7,
                12, 35, 55)
